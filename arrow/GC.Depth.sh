#!/bin/sh
Sample=$1
Script_Path=/data/lipidong/bin/arrow/GC.Depth/
Length_cutoff=10000
...
Rscript ${Script_Path}/Depth_plot.R ${Sample}.Depth.${Length_cutoff}.txt.plot.txt
paste ${Sample}.GC.${Length_cutoff}.txt.change.txt ${Sample}.Depth.${Length_cutoff}.txt.change.txt >${Sample}.GC.Depth.${Length_cutoff}.txt
Rscript  ${Script_Path}/GC.Depth.R ${Sample}.GC.Depth.${Length_cutoff}.txt
