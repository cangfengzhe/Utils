...
# whatshap 分型
whatshap phase --reference $ref --ignore-read-groups --distrust-genotypes -o ${output}/${sample}.phased.vcf ${output}/${sample}.mpileup.hete.vcf $new_bam

# 其他参数
#--distrust-genotypes 不信任SNP InDel位点真实性
