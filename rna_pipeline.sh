...
# tophat
$tophat2 -p 16 -G $gtf_file -o ${output_path} $hg19_bowtie2 ${output_path}/forward_paired.fq.gz,${output_path}/reverse_paired.fq.gz >${output_path}/tophat.o 2>${output_path}/tophat.e

# cufflinks
$cufflinks -p 16 -o ${output_path} ${output_path}/accepted_hits.bam -G ${gtf_file} > ${output_path}/cufflinks.o 2>${output_path}/cufflinks.e
